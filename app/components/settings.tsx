...
export function Settings() {
  ...
  const wenxinConfigComponent = accessStore.provider ===
    ServiceProvider.Wenxin && (
      <>
        <ListItem
          title={Locale.Settings.Access.Wenxin.Endpoint.Title}
          subTitle={
            Locale.Settings.Access.Wenxin.Endpoint.SubTitle +
            Wenxin.ExampleEndpoint
          }
        >
          <input
            aria-label={Locale.Settings.Access.Wenxin.Endpoint.Title}
            type="text"
            value={accessStore.wenxinUrl}
            placeholder={Wenxin.ExampleEndpoint}
            onChange={(e) =>
              accessStore.update(
                (access) => (access.wenxinUrl = e.currentTarget.value),
              )
            }
          ></input>
        </ListItem>
        <ListItem
          title={Locale.Settings.Access.Wenxin.ApiKey.Title}
          subTitle={Locale.Settings.Access.Wenxin.ApiKey.SubTitle}
        >
          <PasswordInput
            aria-label={Locale.Settings.Access.Wenxin.ApiKey.Title}
            value={accessStore.wenxinApiKey}
            type="text"
            placeholder={Locale.Settings.Access.Wenxin.ApiKey.Placeholder}
            onChange={(e) => {
              accessStore.update(
                (access) => (access.wenxinApiKey = e.currentTarget.value),
              );
            }}
          />
        </ListItem>
